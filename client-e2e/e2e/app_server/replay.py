...
from e2e.app_server.config import FIXTURE_PATH, VIBE_DIR
...
def replay_fixture(scenario: Scenario) -> Iterator[str]:
    ...
    responses["initialize"]["serverInfo"]["version"] = _installed_version()
...
def _installed_version() -> str:
    text = (VIBE_DIR / "vibe" / "__init__.py").read_text()
