...
cells on both frontends. The version string is dynamic but both CLIs read it from
the same fixture serverInfo.version, so the rendered cells stay identical.
