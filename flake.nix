  ...
  outputs = {
    ...
    in {
      ...
      packages.default = mkApplication {
        venv = pythonSet.mkVirtualEnv "x-vibe-env" workspace.deps.default;
        package = pythonSet.x-vibe;
      };
        ...
        default = let
          ...
          editablePythonSet = pythonSet.overrideScope (
            lib.composeManyExtensions [
              ...
              (final: prev: {
                x-vibe = prev.x-vibe.overrideAttrs (old: {
          ...
          virtualenv = editablePythonSet.mkVirtualEnv "x-vibe-dev-env" workspace.deps.all;
        in
          pkgs.mkShell {
            packages = [
              virtualenv
